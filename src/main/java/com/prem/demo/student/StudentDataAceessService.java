...
@Repository
public class StudentDataAceessService {

    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public StudentDataAceessService(JdbcTemplate jdbcTemplate) {
    ...
    private static RowMapper<Student> getStudentRowMapper() {
        return (resultSet, i) -> {
            ...
            String genderStr = resultSet.getString("gender").toUpperCase(); //ENUM MALE AND FEMALE
